  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="product-details">
        <h2>Americano</h2>
        <p class="description">
          <b style="color: #df7d32; font-size: 20px">Description:</b> What is an
          americano coffee made of? An americano is just water and espresso.
          It'll either be served 1/2 and 1/2 or 1/3 espresso to 2/3 water,
          depending on the coffee shop in question or how you've chosen to brew
          it.
        </p>
        <p><b style="color: #df7d32; font-size: 20px"> Price:</b><span>$45.00</span></p>
