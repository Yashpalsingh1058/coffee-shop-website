  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="product-details">
        <h2> Cappuccino</h2>
        <p class="description">
          <b style="color: #df7d32; font-size: 20px">Description:</b> A cappuccino is the perfect balance of espresso, steamed milk and foam. This coffee is all about the structure and the even splitting of all elements into equal thirds. An expertly made cappuccino should be rich, but not acidic and have a mildly sweet flavour
        </p>
        <p><b style="color: #df7d32; font-size: 20px"> Price:</b><span> $10.00</span></p>
