  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="product-details">
        <h2> Caramel Cold Foam Cold Brew (12 oz)</h2>
        <p class="description">
          <b style="color: #df7d32; font-size: 20px">Description:</b> Cold foam is a light and frothy milk-based topping typically served over cold brew, iced coffee, or iced tea. Unlike the hot steamed foam you'd find on a latte or cappuccino, cold foam is made by vigorously aerating milk using a blender, special frothing device, or a French press or by simply shaking milk in a jar.
        </p>
        <p><b style="color: #df7d32; font-size: 20px"> Price:</b><span> $55.00</span></p>
