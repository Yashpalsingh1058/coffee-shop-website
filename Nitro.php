  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="product-details">
        <h2>Nitro Cold Brew W/ Straw (12 OZ)</h2>
        <p class="description">
          <b style="color: #df7d32; font-size: 20px">Description:</b> Nitrogen infusion creates microbubbles, giving the coffee a cascading, frothy texture. The result is a velvety-smooth coffee with a subtly sweet flavor and a rich, creamy head of foam. Experience Nitro Cold Brew now—available on tap at participating stores.
        </p>
        <p><b style="color: #df7d32; font-size: 20px"> Price:</b><span> $50.00</span></p>
