...
<body>
            ...
            <div class="row">
                <div class="col">
                    <div class="order-summary">
                        <h2>Order Summary:</h2>
                        <ul>
                            <li>Product 1: [Product Name] - [Price]</li>
                            <li>Product 2: [Product Name] - [Price]</li>
                ...
                <div class="col">
                    <div class="cont">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col">
                                <div class="form-floating mb-2">
                                    <input type="text" class="form-control" id="textinput"  placeholder="name@example.com">
    ...
    <script>
        ...
        function validateForm() {
            ...
            if (nameOnCard === '' || cardNumber === '' || expiryDate === '' || cvv === '' || billingAddress === '' || country === '' || state === '' || city === '' || zipCode === '') {
