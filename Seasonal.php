  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="product-details">
        <h2> Seasonal Single-Origin (12 OZ)</h2>
        <p class="description">
          <b style="color: #df7d32; font-size: 20px">Description:</b> The term “single origin” is a coffee category that gives focus to one distinct area or region where the coffee is grown. Simply put, coffee that is labeled as single origin can be traced to a single farm, farmer, producer, crop or region in one country.
        </p>
        <p><b style="color: #df7d32; font-size: 20px"> Price:</b><span> $30.00</span></p>
