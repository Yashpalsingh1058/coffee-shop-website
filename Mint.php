  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="product-details">
        <h2> Mint Mojito Iced Coffee (12 OZ)</h2>
        <p class="description">
          <b style="color: #df7d32; font-size: 20px">Description:</b> In a cocktail shaker add half of the mint leaves and half the sugar and use a cocktail muddler to gently mash the leaves with the sugar. Fill with ice add 1½ cups of the chilled coffee to the shaker. Cover and shake vigorously. Fill a 12-ounce tumbler with ice then pour the coffee over the top.
        </p>
