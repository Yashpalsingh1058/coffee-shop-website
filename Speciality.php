  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="product-details">
        <h2> Specialty Brews (12 OZ)</h2>
        <p class="description">
          <b style="color: #df7d32; font-size: 20px">Description:</b> Specialty coffee also adheres to high quality control standards from source to roast. From trees to your table, the coffee beans should be unprocessed, free from defects, and must be of the highest grade possible.
        </p>
