  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="product-details">
        <h2> Ethiopian Yirgacheffe Cup (12 OZ)</h2>
        <p class="description">
          <b style="color: #df7d32; font-size: 20px">Description:</b> A premier coffee, grown in the Horn of Africa. Yirgacheffe has a prevalent taste of citrus, which gives the coffee a distinctive tart bite. This coffee brews a smooth and balanced cup with a good body, and rich floral finish.
        </p>
